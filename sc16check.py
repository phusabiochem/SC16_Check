...
hs = list(range(16))
workbook = openpyxl.load_workbook('/home/pi/SC16_Check/coefficient.xlsx')
...
fr1 = open("/home/pi/SC16_Check/coordinates.txt","r")
x1 = int(fr1.readline())
y1 = int(fr1.readline())
x2 = int(fr1.readline())
y2 = int(fr1.readline())
...
#             result_list[i] = round(result_list[i]*0.96,1)
    ...
    # ~ for i in range(1,4):
        # ~ result_list[4*i+1]=round(result_list[4*i+1]*(1-(0.01*round(result_list[6*i]/70) + 0.01*round(result_list[6*i+2]/70) + 0.01*round(result_list[6*i-5]/70) + 0.01*round(result_list[6*i+7]/70) + 0.003*round(result_list[6*i-6]/70) + 0.003*round(result_list[6*i-4]/70) + 0.003*round(result_list[6*i+6]/70) + 0.003*round(result_list[6*i+8]/70))),1)
        # ~ result_list[4*i+2]=round(result_list[4*i+2]*(1-(0.01*round(result_list[6*i+1]/70) + 0.01*round(result_list[6*i+3]/70) + 0.01*round(result_list[6*i-4]/70) + 0.01*round(result_list[6*i+8]/70) + 0.003*round(result_list[6*i-5]/70) + 0.003*round(result_list[6*i-3]/70) + 0.003*round(result_list[6*i+7]/70) + 0.003*round(result_list[6*i+9]/70))),1)
        # ~ result_list[4*i+3]=round(result_list[4*i+3]*(1-(0.01*round(result_list[6*i+2]/70) + 0.01*round(result_list[6*i+4]/70) + 0.01*round(result_list[6*i-3]/70) + 0.01*round(result_list[6*i+9]/70) + 0.003*round(result_list[6*i-4]/70) + 0.003*round(result_list[6*i-2]/70) + 0.003*round(result_list[6*i+8]/70) + 0.003*round(result_list[6*i+10]/70))),1)
        # ~ result_list[4*i+4]=round(result_list[4*i+4]*(1-(0.01*round(result_list[6*i+3]/70) + 0.01*round(result_list[6*i+5]/70) + 0.01*round(result_list[6*i-2]/70) + 0.01*round(result_list[6*i+10]/70) + 0.003*round(result_list[6*i-3]/70) + 0.003*round(result_list[6*i-1]/70) + 0.003*round(result_list[6*i+9]/70) + 0.003*round(result_list[6*i+11]/70))),1)
        # ~ result_list[4*i]=round(result_list[4*i]*(1-(0.01*round(result_list[6*i+1]/70) + 0.01*round(result_list[6*i-6]/70) + 0.01*round(result_list[6*i+6]/70))),1)
        # ~ result_list[4*i+5]=round(result_list[4*i+5]*(1-(0.01*round(result_list[6*i+4]/70) + 0.01*round(result_list[6*i-1]/70) + 0.01*round(result_list[6*i+11]/70))),1)
